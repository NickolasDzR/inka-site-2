...
gsap.set(removeAnimation, {delay: 0, onRepeat: removeAnimation, duration: 2, repeat: -1, repeatDelay: 4});
gsap.set(addAnimation, {delay: 2, onRepeat: addAnimation, duration: 2, repeat: -1, repeatDelay: 4});
